...
class choose_related_habit_or_reward():
    ...
    def __call__(self, related_habit, reward):
...
class related_is_pleasant():
    ...
    def __call__(self, related_habit, sign_of_pleasant):
        related_habit = Habit.objects.filter(habit_id=related_habit)
        if related_habit.sign_of_pleasant != sign_of_pleasant:
...
class pleasant_format():
    ...
    def __call__(self, sign_of_pleasant):
